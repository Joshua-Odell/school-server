CREATE TABLE incident (
    ...
    hold_one INTEGER REFERENCES holds(id),
    hold_two INTEGER REFERENCES holds(id),
    hold_three INTEGER REFERENCES holds(id),
    hold_four INTEGER REFERENCES holds(id),
    hold_five INTEGER REFERENCES holds(id),
